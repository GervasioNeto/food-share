...
export default function ProfileScreen() {
  ...
  const [stats, setStats] = useState<Stats>({ total: 0, completed: 0, kg_donated: 0 });
    ...
    <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.container}>
        ...
        <View style={s.infoCard}>
          ...
          {profile?.phone && <InfoRow icon="📞" label="Telefone" value={profile.phone} />}
        </View>
...
const s = StyleSheet.create({
  ...
  avatar: {
    width: 90, height: 90, borderRadius: 45, backgroundColor: '#1a2e25',
  ...
  roleBadge: { paddingHorizontal: 14, paddingVertical: 5, borderRadius: 12, marginBottom: 8 },
  roleText: { fontSize: 13, fontWeight: '600' },
  address: { fontSize: 13, color: '#666', marginTop: 4 },
  impactCard: {
    backgroundColor: '#1E1E1E', borderRadius: 16, padding: 20,
    borderWidth: 1, borderColor: '#2E2E2E', marginBottom: 16,
  },
  impactTitle: { fontSize: 16, fontWeight: '700', color: '#FFF', marginBottom: 16 },
  statsRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  divider: { width: 1, height: 32, backgroundColor: '#2E2E2E' },
  statValue: { fontSize: 24, fontWeight: '800', color: '#3DDC97' },
  statLabel: { fontSize: 12, color: '#888', marginTop: 2 },
  progressBar: {
    height: 6, backgroundColor: '#2E2E2E', borderRadius: 3, overflow: 'hidden', marginBottom: 8,
  },
  ...
  infoCard: {
    ...
    borderWidth: 1, borderColor: '#2E2E2E', marginBottom: 24, gap: 12,
  },
  ...
  signOutBtn: {
    borderWidth: 1, borderColor: '#FF4D4D', borderRadius: 12, padding: 16, alignItems: 'center',
  },
